                                        ...
                                        <div class="hiXKxx">
                                            ...
                                            <div class="AM4Cxf">
                                                <div class="EOjXew">
                                                    ...
                                                    <button class={`button button-dark js_make_appointment_btn js_ma_watch_button ${(order.status === 3 || order.status === 4) ? 'disabled' : ''}`} onClick={() => handleCancelOrder(order._id)} disabled={(order.status === 3 || order.status === 4)}>Cancel</button>
